...
```prisma
    DATABASE_URL=postgres://DATABASEUSERNAME:DATABASEPASSWORD@localhost:5432/DATABASENAME
```

# Add changes to models
...
You can view the database entries in Prisma Studio by running the following command:
